            ...
            steps {
                sshagent (credentials: ['ssh-deploy']) {
                    sh '''
                        ...
                        ansible-playbook -i ~/workspace/ansible-project/ansible-example-jenkins/hosts.yml -l deploymentjenkins ~/workspace/ansible-project/ansible-example-jenkins/playbooks/mailhog.yml
                        '''
            }
